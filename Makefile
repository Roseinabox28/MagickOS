kernel_source_files := $(shell find src/impl/kernal -name *.c)
kernel_object_files := $(patsubst src/impl/kernal/%.c, build/kernal/%.o, $(kernel_source_files))
...
$(kernel_object_files): build/kernal/%.o : src/impl/kernal/%.c
	mkdir -p $(dir $@) && \
